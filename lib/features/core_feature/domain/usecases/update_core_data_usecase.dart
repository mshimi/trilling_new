...
class UpdateCoreDataUseCase {
  final CoreDataRepo coreDataRepo;

  UpdateCoreDataUseCase({required this.coreDataRepo});

 Future<Either<Failure, Unit>> call({required CoreDataModel coreDataModel}) async {
   return await coreDataRepo.updateCoreData(coreDataModel: coreDataModel);
  }
}
